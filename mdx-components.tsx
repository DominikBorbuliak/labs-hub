...
const components: MDXComponents = {
  ...
  h3: ({ node: _node, ...props }) => <h3 className="text-2xl font-semibold mb-3 mt-6" {...props} />,
  h4: ({ node: _node, ...props }) => <h4 className="text-xl font-semibold mb-2 mt-4" {...props} />,
  h5: ({ node: _node, ...props }) => <h5 className="text-lg font-semibold mb-2 mt-3" {...props} />,
  h6: ({ node: _node, ...props }) => (
    <h6 className="text-base font-semibold mb-2 mt-3" {...props} />
  ),
  p: ({ node: _node, ...props }) => <p className="mb-4 leading-relaxed text-gray-800" {...props} />,
  strong: ({ node: _node, ...props }) => (
    <strong className="font-semibold text-gray-900" {...props} />
  ),
  em: ({ node: _node, ...props }) => <em className="italic" {...props} />,
  ul: ({ node: _node, ...props }) => <ul className="list-disc pl-6 mb-6 space-y-2" {...props} />,
  ol: ({ node: _node, ...props }) => <ol className="list-decimal pl-6 mb-6 space-y-2" {...props} />,
  ...
  hr: ({ node: _node, ...props }) => <hr className="my-8 border-t-2 border-gray-300" {...props} />,
  ...
  tr: ({ node: _node, ...props }) => <tr className="border-b border-gray-300" {...props} />,
  th: ({ node: _node, ...props }) => (
    <th
  ...
  img: (props) => {
    const { node: _node, alt, src, width, height, ...rest } = props;
